...
class YourHomePage extends StatelessWidget {
  ...
  void navigateToSecondPage(BuildContext context, Product product) {
                            ...
                            child: InkWell(
                              onTap: () {
                                final selectedProduct = Product(
                                  'Armani Woman Trousers',
                                  'Description of the selected product',
                                  1200.0,
                                  ['assets/images/clothes_women.jpg', 'assets/images/coat2.jpg', 'assets/images/coat3.jpg'],
                                );
                                navigateToSecondPage(context, selectedProduct);
                                /*Navigator.of(context).push(
                                  PageRouteBuilder(
